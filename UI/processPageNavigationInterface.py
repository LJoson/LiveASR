...
class ProcessPageNavigationInterface(NavigationBaseInterface):
    ...
    def setupUI(self):
        ...
        self.transceibe_Files_RadioButton.setEnabled(False)
        self.transceibe_Files_RadioButton.setChecked(False)
        ...
        self.audio_capture_RadioButton.setEnabled(True)
        self.audio_capture_RadioButton.setChecked(True)
        ...
        # self.combox_capture.setEnabled(True)
        ...
        self.button_process.setIcon(FasterGUIIcon.PROCESS)

        self.addWidget(self.button_process)

        # ------------------------------------------------------------------------------------------
        self.processResultText = TextEdit()
        self.processResultText.setFixedHeight(600)
